          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Cuti Alasan Penting</h4>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Cuti Alasan Penting</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="exampleInputPassword1" name="tgl_mul">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Tanggal Selesai</label>
                                <input type="date" class="form-control" id="exampleInputPassword1" name="tgl_sls">
                            </div>
                            <div class="form-group">
